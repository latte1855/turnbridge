...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOREDOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STOREDOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STOREDOBJECT actions', async () => {
      const arg = { id: 29972 };
    ...
    it('dispatches UPDATE_STOREDOBJECT actions', async () => {
      const arg = { id: 29972 };
    ...
    it('dispatches PARTIAL_UPDATE_STOREDOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STOREDOBJECT actions', async () => {
      const arg = 42666;
