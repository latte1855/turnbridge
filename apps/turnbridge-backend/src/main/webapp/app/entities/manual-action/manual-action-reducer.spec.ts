...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MANUALACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MANUALACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MANUALACTION actions', async () => {
      const arg = { id: 7204 };
    ...
    it('dispatches UPDATE_MANUALACTION actions', async () => {
      const arg = { id: 7204 };
    ...
    it('dispatches PARTIAL_UPDATE_MANUALACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MANUALACTION actions', async () => {
      const arg = 42666;
