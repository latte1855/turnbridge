...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEBHOOKENDPOINT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WEBHOOKENDPOINT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WEBHOOKENDPOINT actions', async () => {
      const arg = { id: 19915 };
    ...
    it('dispatches UPDATE_WEBHOOKENDPOINT actions', async () => {
      const arg = { id: 19915 };
    ...
    it('dispatches PARTIAL_UPDATE_WEBHOOKENDPOINT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WEBHOOKENDPOINT actions', async () => {
      const arg = 42666;
