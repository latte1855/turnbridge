...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UPLOADJOB_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UPLOADJOB actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UPLOADJOB actions', async () => {
      const arg = { id: 14392 };
    ...
    it('dispatches UPDATE_UPLOADJOB actions', async () => {
      const arg = { id: 14392 };
    ...
    it('dispatches PARTIAL_UPDATE_UPLOADJOB actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UPLOADJOB actions', async () => {
      const arg = 42666;
