...
import reducer, {
  ...
  reset,
  updateEntity,
} from './import-file-item-error.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMPORTFILEITEMERROR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_IMPORTFILEITEMERROR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_IMPORTFILEITEMERROR actions', async () => {
      const arg = { id: 24439 };
    ...
    it('dispatches UPDATE_IMPORTFILEITEMERROR actions', async () => {
      const arg = { id: 24439 };
    ...
    it('dispatches PARTIAL_UPDATE_IMPORTFILEITEMERROR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_IMPORTFILEITEMERROR actions', async () => {
      const arg = 42666;
