...
import reducer, {
  ...
  reset,
  updateEntity,
} from './webhook-delivery-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEBHOOKDELIVERYLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WEBHOOKDELIVERYLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WEBHOOKDELIVERYLOG actions', async () => {
      const arg = { id: 12497 };
    ...
    it('dispatches UPDATE_WEBHOOKDELIVERYLOG actions', async () => {
      const arg = { id: 12497 };
    ...
    it('dispatches PARTIAL_UPDATE_WEBHOOKDELIVERYLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WEBHOOKDELIVERYLOG actions', async () => {
      const arg = 42666;
