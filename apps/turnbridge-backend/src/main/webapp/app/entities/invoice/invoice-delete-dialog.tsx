...
export const InvoiceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="turnbridgeBackendApp.invoice.delete.question">
        <Translate contentKey="turnbridgeBackendApp.invoice.delete.question" interpolate={{ id: invoiceEntity.id }}>
