...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UPLOADJOBITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UPLOADJOBITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UPLOADJOBITEM actions', async () => {
      const arg = { id: 6364 };
    ...
    it('dispatches UPDATE_UPLOADJOBITEM actions', async () => {
      const arg = { id: 6364 };
    ...
    it('dispatches PARTIAL_UPDATE_UPLOADJOBITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UPLOADJOBITEM actions', async () => {
      const arg = 42666;
