...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRACKRANGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRACKRANGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRACKRANGE actions', async () => {
      const arg = { id: 14853 };
    ...
    it('dispatches UPDATE_TRACKRANGE actions', async () => {
      const arg = { id: 14853 };
    ...
    it('dispatches PARTIAL_UPDATE_TRACKRANGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRACKRANGE actions', async () => {
      const arg = 42666;
