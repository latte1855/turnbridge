...
import reducer, {
  ...
  reset,
  updateEntity,
} from './invoice-assign-no.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVOICEASSIGNNO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INVOICEASSIGNNO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INVOICEASSIGNNO actions', async () => {
      const arg = { id: 13588 };
    ...
    it('dispatches UPDATE_INVOICEASSIGNNO actions', async () => {
      const arg = { id: 13588 };
    ...
    it('dispatches PARTIAL_UPDATE_INVOICEASSIGNNO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INVOICEASSIGNNO actions', async () => {
      const arg = 42666;
