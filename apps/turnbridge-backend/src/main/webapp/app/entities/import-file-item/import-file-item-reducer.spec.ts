...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMPORTFILEITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_IMPORTFILEITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_IMPORTFILEITEM actions', async () => {
      const arg = { id: 16311 };
    ...
    it('dispatches UPDATE_IMPORTFILEITEM actions', async () => {
      const arg = { id: 16311 };
    ...
    it('dispatches PARTIAL_UPDATE_IMPORTFILEITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_IMPORTFILEITEM actions', async () => {
      const arg = 42666;
