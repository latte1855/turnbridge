...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TURNKEYMESSAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TURNKEYMESSAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TURNKEYMESSAGE actions', async () => {
      const arg = { id: 9152 };
    ...
    it('dispatches UPDATE_TURNKEYMESSAGE actions', async () => {
      const arg = { id: 9152 };
    ...
    it('dispatches PARTIAL_UPDATE_TURNKEYMESSAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TURNKEYMESSAGE actions', async () => {
      const arg = 42666;
