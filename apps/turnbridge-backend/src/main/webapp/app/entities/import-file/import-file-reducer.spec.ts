...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMPORTFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_IMPORTFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_IMPORTFILE actions', async () => {
      const arg = { id: 32767 };
    ...
    it('dispatches UPDATE_IMPORTFILE actions', async () => {
      const arg = { id: 32767 };
    ...
    it('dispatches PARTIAL_UPDATE_IMPORTFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_IMPORTFILE actions', async () => {
      const arg = 42666;
