...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVOICEITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INVOICEITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INVOICEITEM actions', async () => {
      const arg = { id: 28999 };
    ...
    it('dispatches UPDATE_INVOICEITEM actions', async () => {
      const arg = { id: 28999 };
    ...
    it('dispatches PARTIAL_UPDATE_INVOICEITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INVOICEITEM actions', async () => {
      const arg = 42666;
