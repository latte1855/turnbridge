...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMPORTFILELOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_IMPORTFILELOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_IMPORTFILELOG actions', async () => {
      const arg = { id: 29085 };
    ...
    it('dispatches UPDATE_IMPORTFILELOG actions', async () => {
      const arg = { id: 29085 };
    ...
    it('dispatches PARTIAL_UPDATE_IMPORTFILELOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_IMPORTFILELOG actions', async () => {
      const arg = 42666;
