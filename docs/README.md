...
| `integration/` | 外部整合指南（Turnkey、Webhook、API 測試腳本） | `README.md`（本目錄索引）、待搬遷之 Turnkey/Webhook 深入說明 | 整合工程師 |
| `operations/` | Runbook、監控、人工流程、稽核證跡 | `README.md`（本目錄索引）、待撰寫之 `monitoring.md`、`incident-playbook.md` | SRE / Ops |
