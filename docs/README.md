...
| 目錄 | 用途 | 代表文件 / 內容 | 主要負責人 |
| --- | --- | --- | --- |
| `requirements/` | 決策、容量、訪談、Webhook 契約 | `DECISION_LOG_v0.3.md`、`CAPACITY_AND_ARCHITECTURE.md`、`turnkey_system_interview_draft_v0.3.md`、`webhook_spec.md`、`dev-readiness.md` | PO / 系統分析 |
...
| `integration/` | 外部整合指南（Turnkey、Webhook、API 測試腳本） | `README.md`、`turnkey-webhook.md`、`turnkey-flow.yaml`、`turnkey-flow.md`、`mock-turnkey.md`、`webhook-contract.md`、`test-scripts.md`、`scripts/newman-smoke.sh`、`ci-newman.md`、`e2e-scenarios.md` | 整合工程師 |
| `tools/agent-tests/` | Agent 端測試樣板（Node/Java） | `README.md`、Node/Java 範例、樣本資料 | Agent 團隊 |
